import { Input, Icon, Timeline, Badge } from 'antd';
...
function Tag({ text }) {
    return <span style={{ display: 'inline-block', border: '1px solid blue', color: 'blue', background: '#eee', padding: '0 4px', borderRadius: '4px' }}>
      {text}
    </span>
}