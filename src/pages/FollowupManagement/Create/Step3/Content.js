            ...
            {['孕妇姓名', '复诊预约时间', '超时天数'].map(_ => {
                ...
                <div style={{ textAlign: 'center' }}>
                    <Button className={mRb8} onClick={() => setVisible(true)}>
                        预览          </Button>
                    <Button type="primary" className={mRb8} onClick={() => onUp(index)}>                       上一步          </Button>
                    <Button type="primary" className={mRb8} onClick={() => onDown(index)}>                        下一步          </Button>
                    <Button type="primary" className={mRb8} onClick={() => router.push('step4')}>                        确定          </Button>
                </div>
                <Preview
