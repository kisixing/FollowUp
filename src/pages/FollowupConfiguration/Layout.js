...
export default connect(mapStateToProps)(({ tabList, tabActiveKey, children, dispatch, configurationName }, context) => {
    ...
    const mainSearch = (
        <div style={{ textAlign: 'center', marginBottom: '14px' }}>
            ...
            />
            {
                configurationName === 'medium' ? null : <Button type="primary" icon="plus" size="large" style={{ float: 'right' }}>新增</Button>
            }
        </div>
    );
